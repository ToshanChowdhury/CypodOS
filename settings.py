...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        assistant = QAction("Assistant", self)
        ...
        self.apps_menu.addActions(
            [file_manager, calculator, codeeditor, notes, terminal, webbrowser, calendar, time_app, google_docs,
             google_sheets, google_slides])
